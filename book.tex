...
\begin{center}
$$\Delta y = \varepsilon \sum \limits_{k=1}^{n} \frac{1}{k} X_k(\xi) , \; \; \| \Delta y\|^2 = \varepsilon ^2 \sum\limits_{k=1}^{n} \frac{1}{k^2} < \varepsilon^2 \frac{\pi ^2}{6} \; \; \mbox{и} \; \; \| \Delta y \| < \frac{\varepsilon}{\sqrt{6}}\pi.$$
\end{center}
...
$$|y(t_2)-y(t_1)|^2 \leqslant \displaystyle\int\limits_a^b |\widetilde{K}(t_2, \tau)-\widetilde{K}(t_1, \tau)|^2d\tau \cdot \displaystyle\int\limits_a^b |x(\tau)|^2 d\tau \leqslant \varepsilon^2 (b-a){\lVert x\rVert^2}_{L_2(a,b)}.$$
