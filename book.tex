...
\begin{enumerate}
	...
	\begin{equation*}
	\frac{d^nx(t)}{dt^n}+a_1\frac{d^{n-1}x(t)}{dt^{n-1}}+\dotsb+a_{n-1}\frac{dx(t)}{dt}+a_n=0 \mbox{, где } a_k\in C[t_0,t_1]
	\end{equation*}
...
(x,x) + 2 Re(\lambda y, x) + |\lambda|^2 (y, y) \ge 0 \mbox{ для любых чисел } \lambda\\
\end{gather*}
