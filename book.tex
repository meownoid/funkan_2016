...
\begin{center}
$\lVert A_n(x_0+\frac{r}{\lVert x\rVert}x)\rVert \leqslant c$, т.е.
...
$2c \geqslant \frac{r}{\lVert x\rVert}\lVert A_n x\rVert$, $\frac{2c}{r}\lVert x\rVert \geqslant \lVert A_n x\rVert$, $\lVert A_n x\rVert \leqslant \frac{2c}{r}\lVert x\rVert$
\end{center}
